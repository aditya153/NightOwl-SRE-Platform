  ...
  return (
    <aside className="w-64 h-screen bg-[#0e0e0e] border-r border-[#1c1b1b] flex flex-col font-sans tracking-tight z-50">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <a href="/" className={`flex items-center gap-3 px-4 py-2.5 rounded-sm transition-colors text-sm font-medium ${location === '/' ? 'bg-[#1c1b1b] text-[#ffffff] border-l-2 border-[#3b82f6]' : 'text-[#c6c6c6] hover:bg-[#131313] hover:text-[#e5e2e1] border-l-2 border-transparent'}`}>
          Overview
        </a>
        
        <a href="/incidents" className={`flex items-center gap-3 px-4 py-2.5 rounded-sm transition-colors text-sm font-medium ${location === '/incidents' ? 'bg-[#1c1b1b] text-[#ffffff] border-l-2 border-[#3b82f6]' : 'text-[#c6c6c6] hover:bg-[#131313] hover:text-[#e5e2e1] border-l-2 border-transparent'}`}>
          Incidents <span className="ml-auto bg-[#3b82f6]/20 text-[#4d8eff] py-0.5 px-2 rounded-sm text-[10px] font-mono">12</span>
        </a>
        
        <a href="/agents" className={`flex items-center gap-3 px-4 py-2.5 rounded-sm transition-colors text-sm font-medium ${location === '/agents' ? 'bg-[#1c1b1b] text-[#ffffff] border-l-2 border-[#3b82f6]' : 'text-[#c6c6c6] hover:bg-[#131313] hover:text-[#e5e2e1] border-l-2 border-transparent'}`}>
          AI Agents
        </a>
      </nav>
